...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.DATE_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id AND m.dateTime >=:date_time AND m.dateTime <:date_time ORDER BY m.dateTime DESC"),
})
@Entity
@Table(name = "meals")
